  ...
  const services = [
    {
      ...
      description: 'Enterprise-grade cloud software solutions powered by artificial intelligence and machine learning algorithms.',
      icon: (
    ...
    },
    {
      ...
      description: 'Mission-critical infrastructure management handling millions of transactions with guaranteed uptime and scalability.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Modern microservices-based infrastructure built on Kubernetes and containerization technologies.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Comprehensive digital transformation strategy and implementation for legacy system modernization.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Advanced DevOps practices and continuous integration/deployment pipelines for rapid software delivery.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Comprehensive security solutions meeting international standards and regulatory compliance requirements.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  const processSteps = [
    {
      ...
      description: 'Comprehensive assessment of your business requirements, technical infrastructure, and strategic objectives.',
      icon: (
    ...
    },
    {
      ...
      description: 'Design of scalable system architecture and comprehensive technical roadmap aligned with business goals.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Agile development methodology with continuous integration and rigorous quality assurance protocols.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    },
    {
      ...
      description: 'Seamless production deployment with performance optimization, monitoring setup, and ongoing support.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed font-light px-4">
            Comprehensive enterprise software solutions designed to accelerate digital transformation and drive operational excellence
          </p>
        </motion.div>
        ...
        >
          <div className="text-center mb-14">
            ...
            <p className="text-base sm:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed font-light">
              Our structured approach ensures successful project delivery from initial consultation to ongoing support
            </p>
          </div>
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed font-light">
            Let's discuss how our enterprise software solutions can accelerate your digital transformation journey
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-700">
            <p className="text-xs text-gray-500">
              Trusted by 500+ enterprise clients worldwide • ISO 27001 & SOC 2 certified
            </p>
          </div>
        </motion.div>
      </div>
